(() => {
  ...
  function organizeResources(name) {
    ...
    const sourceEvidence = name === "Merthyr Tydfil" ? `<ul class="source-evidence-list"><li>No transcriptions or minutes are currently linked.</li><li>Source: LR54507, CD 29</li><li>Years identified: 1843-1896</li></ul>` : `<p>${[d?.filmAndCallNumbers, d?.comparisonStatus, d?.localNote].filter(Boolean).join(" · ") || "Detailed source coverage has not yet been entered."}</p>`;
