(() => {
  ...
  function organizeResources(name) {
    ...
    if (name !== "Merthyr Tydfil" && grouped.slice(1).every((group) => !group.cards.length)) { const empty = document.createElement("p"); empty.className = "resource-empty resource-empty-combined"; empty.textContent = "No transcriptions, minutes, or related research material are currently linked."; fragment.append(empty); }
    ...
    const sourceEvidence = name === "Merthyr Tydfil" ? `<ul class="source-evidence-list"><li><strong>Membership-register provenance:</strong> LR54507 · CD 29</li><li><strong>Years identified:</strong> 1843-1896</li><li><strong>Typed branch-record extracts:</strong> Candidate Merthyr references are indexed privately; manual review and branch-page linking remain to be completed.</li><li><strong>Transcriptions or minutes:</strong> None are currently linked to this branch page.</li><li><strong>Research notes:</strong> Recovered Wales2Utah branch notes are available for review.</li></ul>` : `<p>${[d?.filmAndCallNumbers, d?.comparisonStatus, d?.localNote].filter(Boolean).join(" · ") || "Detailed source coverage has not yet been entered."}</p>`;
